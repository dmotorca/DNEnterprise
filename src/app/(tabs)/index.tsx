...
export default function HomeScreen() {
  ...
  const cameraPosition = {
    coordinates: {
      latitude: locationList[locationIndex].busStops[0].point[0],
      longitude: locationList[locationIndex].busStops[0].point[1],
    },
    zoom: SF_ZOOM,
  };
  ...
  function handleChangeWithRef(direction: 'next' | 'prev') {
    ...
    ref.current?.setCameraPosition({
      coordinates: {
        latitude: nextLocation.busStops[0].point[0],
        longitude: nextLocation.busStops[0].point[1],
      },
      zoom: SF_ZOOM,
    });
...
const markersApple = [
  {
    coordinates: {
      latitude: 45.479238467507145,
      longitude: -122.61217804894261,
    },
    title: 'I am currently here on Route 19 Woodstock/Glisan',
    tintColor: 'green',
    systemImage: 'bus',
  },
  {
    coordinates: { latitude: 45.5047394, longitude: -122.6341662 },
    title: 'I am currently here on Route FX-2 Division',
    tintColor: 'green',
    systemImage: 'bus',
  },
  {
